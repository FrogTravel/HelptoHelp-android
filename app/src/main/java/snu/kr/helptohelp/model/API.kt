...
class API{
    companion object {
        ...
        val futureEvent1 = Event(0, user1, "Korean", "Whole every miles as tiled at seven or. Wished he entire esteem mr oh by. Possible bed you pleasure civility boy elegance ham.", "Seoul")
